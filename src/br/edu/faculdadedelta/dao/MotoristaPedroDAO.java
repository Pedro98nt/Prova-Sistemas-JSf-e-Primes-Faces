...
public class MotoristaPedroDAO {

	public void incluir(MotoristaPedro motorista) throws ClassNotFoundException, SQLException {
	...
	public void alterar(MotoristaPedro motorista) throws ClassNotFoundException, SQLException {
		Connection conn = Conexao.conectarNoBancoDeDados();
		String sql = "UPDATE motoristas_viagens SET id = ?, nome_motorista = ?, destino = ?, distancia = ?, valor_km = ?, data_corrida = ? WHERE id_mot = ?";
		PreparedStatement ps = conn.prepareStatement(sql);
	...
	public void excluir(MotoristaPedro motorista) throws ClassNotFoundException, SQLException {
		Connection conn = Conexao.conectarNoBancoDeDados();
	...
	public List<MotoristaPedro> listar() throws ClassNotFoundException, SQLException {
		Connection conn = Conexao.conectarNoBancoDeDados();
